...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($nameError) && empty($emailError) && empty($passwordError)) {
      ...
      $stmt->bind_param("sssd", $name, $email, $password, $age);
      $stmt->execute();
      $stmt->close();
  ...
  <div class="container mt-3">
    ...
    <form method="post">
      ...
      <div class="mb-3 mt-3">
        ...
        <input type="text" class="form-control" id="email" value="<?php echo $email ?>" placeholder="Enter email"
          name="email">
        <span class="text-danger">
          <?php echo $emailError ?>
        </span>
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" id="age" value="<?php echo $age ?>" placeholder="Enter age"
          name="age">
        <span class="text-danger">
          <?php echo $ageError ?>
        </span>
