...
<body>
    ...
    <div class="container mt-3">
        ...
        <div class="create-filter-employee">
            <a class="btn btn-primary" href="asc.php">Sort Name ASC</a>
            <a class="btn btn-primary" href="desc.php">Sort Name DESC</a>
                ...
                if ($result->num_rows > 0) {
                    foreach ($result as $patient) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $patient['gender'] ? "Male" : "Female" ?>
                            </td>
                            <td>
                            ...
                            <td><a onclick="return confirm('Are you sure to delete this?')"
                                    href="delete_patient.php?id=<?php echo $patient['id'] ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <?php
                    }
